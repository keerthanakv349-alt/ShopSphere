...
"""
Auth endpoints: signup, login, refresh, logout, me, update profile.
"""
...
def update_me(
    ...
    The user is obtained from the JWT through get_current_user,
    so the client cannot choose another user's ID.
    """
